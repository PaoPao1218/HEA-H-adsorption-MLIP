...
Fig 1–8 are generated by `hea_make_figures.py`, Fig 9–10 by `hea_formability.py`, Fig 11 by `hea_gp_active_learning.py`, all into `figures/` (300 dpi). They are committed for quick preview.
...
![Fig 11 — HER thermoneutral reachability under the min-frac constraint](figures/fig11_thermoneutral_reachability.png)
